...
function apriPannelloFatiche() {
  ...
  document.getElementById("battle-report-content").innerHTML = `
    <div style="padding:20px; text-align:center; color:#cbd5e0;">
      <p style="font-size:1rem; margin-bottom:10px;">Qui troverai presto le Dodici Fatiche e altre sfide sempre nuove per mettere alla prova il tuo Deck.</p>
      <p style="font-size:0.85rem; color:#a89a7a;">Sezione in costruzione — torna a trovarci presto, Evocatore.</p>
    </div>`;
...
function apriPannelloDentroIlMito() {
  ...
  document.getElementById("battle-report-content").innerHTML = `
    <div style="padding:20px; text-align:center; color:#cbd5e0;">
      <p style="font-size:1rem; margin-bottom:10px;">Presto qui potrai scoprire l'origine mitologica di ogni creatura della tua collezione.</p>
      <p style="font-size:0.85rem; color:#a89a7a;">Sezione in costruzione — torna a trovarci presto, Evocatore.</p>
    </div>`;
