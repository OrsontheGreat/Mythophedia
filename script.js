...
function mostraCartaFullscreen(carta, opzioniExtra) {
  ...
  const bottoneAzioneHTML = modalitaBattaglia
    ? `<button type="button" class="attack-btn fs-card-vendi" id="fs-card-battaglia-btn" style="background:linear-gradient(to bottom, #2f855a, #22543d); border-color:#22543d;">⚔️ Vai in Battaglia</button>`
