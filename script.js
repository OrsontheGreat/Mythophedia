...
function apriPannelloFatiche() {
  ...
  document.getElementById("battle-report-content").innerHTML = `
    <div style="padding:24px; text-align:center; color:#e0d5c1; background:rgba(15,10,5,0.55); border-radius:12px; margin-top:10px;">
      ...
      <p style="font-size:0.85rem; color:#c9a054;">Sezione in costruzione — torna a trovarci presto, Evocatore.</p>
    </div>`;
