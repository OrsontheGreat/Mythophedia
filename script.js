...
function htmlHubFatiche() {
  return `
    <div style="display:flex; flex-direction:column; gap:14px; padding:20px; align-items:center; justify-content:center; height:100%;">
      ...
      <button type="button" id="hub-btn-cavalle" class="events-btn events-btn-main" style="width:100%; max-width:360px; padding:18px; font-size:1rem;">
...
async function affrontaTappaCavalle() {
  ...
  document.getElementById("cavalle-esito-tappa").innerText = `${tappa.nome} scalpita minacciosa...`;
    ...
    return `
      <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; height:100%; gap:14px; padding:14px;">
        <div style="background:rgba(15,10,5,0.6); border-radius:10px; padding:14px; color:#e0d5c1; font-size:0.85rem; max-width:360px; text-align:center;">
          Scegli quante Dracme rischiare. Ad ogni cavalla superata il moltiplicatore cresce — puoi ritirarti quando vuoi, ma un passo falso ti costa l'intera puntata.
        </div>
