...
function renderizzaSelezioneSottomondi() {
  ...
  STRUTTURA_SOTTOMONDI.forEach(sub => {
    ...
    btn.addEventListener("click", () => {
      ...
      const titoloTesto = mondoSelezionatoCorrente.nome + " · " + sub.nome;

      const banner = document.getElementById("sottomondo-banner");
      const bannerTitolo = document.getElementById("sottomondo-banner-titolo");
      const headerTitolo = document.getElementById("map-header-title");

      if (banner) {
        const sfondo = SOTTOMONDO_SFONDI[sub.id];
        if (sfondo) {
          banner.style.backgroundImage = `linear-gradient(rgba(10,8,5,0.3), rgba(10,8,5,0.3)), url('${sfondo}')`;
          banner.classList.remove("hidden");
          if (bannerTitolo) bannerTitolo.innerText = titoloTesto;
          if (headerTitolo) headerTitolo.innerText = "";
        } else {
          banner.classList.add("hidden");
          if (headerTitolo) headerTitolo.innerText = titoloTesto;
        }
      }
...
const FATICHE_DODICI = [
  ...
  { numero: 4, id: "trappola-neve", nome: "La Trappola nella Neve", emoji: "🐗", slug: "trappola-nella-neve", implementata: false },
  ...
  { numero: 7, id: "toro-furioso", nome: "Il Toro Furioso", emoji: "🐂", slug: "toro-furioso", implementata: false },
  { numero: 8, id: "cavalle", nome: "Le Cavalle Famigliche", emoji: "🐴", slug: "cavalle-famigliche", implementata: true },
  { numero: 9, id: "dono-amazzone", nome: "Il Dono dell'Amazzone", emoji: "🏹", slug: "dono-dell-amazzone", implementata: false },
  { numero: 10, id: "gregge-errante", nome: "Il Gregge Errante", emoji: "🐮", slug: "gregge-errante", implementata: false },
  { numero: 11, id: "giardino-custodito", nome: "Il Giardino Custodito", emoji: "🍎", slug: "giardino-custodito", implementata: false },
  { numero: 12, id: "porte-inferi", nome: "Le Porte degli Inferi", emoji: "🐕", slug: "porte-degli-inferi", implementata: false }
];
