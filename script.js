...
const CARTE_FISSE = [
  ...
  { nome: "Sfinge", cultura: "Greco-Egizia", tratti: ["arrampicata"], immagine: "img/carte/sfinge.jpg", livello: 3, statisticheFisse: { ferocia: 3.0, balzo: 3.0, corazza: 4.5, istinto: 5.5 } },
  ...
  { nome: "Ammit", cultura: "Egizia", tratti: ["nuoto"], immagine: "img/carte/ammit.jpg", livello: 4, statisticheFisse: { ferocia: 8.0, balzo: 3.0, corazza: 5.5, istinto: 3.5 } },
  { nome: "Zmey Gorynych", cultura: "Slava", tratti: ["volo", "arrampicata"], immagine: "img/carte/zmey-gorynych.jpg", livello: 4, statisticheFisse: { ferocia: 7.5, balzo: 5.0, corazza: 6.0, istinto: 1.5 } },
  { nome: "Kraken", cultura: "Norrena/Scandinava", tratti: ["nuoto"], immagine: "img/carte/kraken.jpg", livello: 4, statisticheFisse: { ferocia: 6.5, balzo: 3.0, corazza: 7.5, istinto: 3.0 } },
  { nome: "Behemoth", cultura: "Ebraica/Biblica", tratti: ["arrampicata"], immagine: "img/carte/behemoth.jpg", livello: 4, statisticheFisse: { ferocia: 5.0, balzo: 2.0, corazza: 9.5, istinto: 3.5 } },
  ...
  { nome: "Sekhmet", cultura: "Egizia", tratti: ["equilibrio"], immagine: "img/carte/sekhmet.jpg", livello: 5, statisticheFisse: { ferocia: 9.0, balzo: 5.0, corazza: 5.5, istinto: 4.5 } },
  { nome: "Apophis", cultura: "Egizia", tratti: ["nuoto"], immagine: "img/carte/apophis.jpg", livello: 5, statisticheFisse: { ferocia: 6.5, balzo: 4.5, corazza: 7.5, istinto: 5.5 } }
];
...
function ritiraPremioAugia() {
  ...
  if (premio > 0) segnaFaticaCompletata("augia");
...
function gestisciEsitoInseguimento(indovinata) {
  ...
  if (indovinata) {
    ...
    segnaFaticaCompletata("inseguimento");
  } else {
...
function tickSonaglio() {
  ...
  if (adesso >= sonaglioFineTs) {
    ...
    dracmeAttuali += premio;
    if (premio > 0) segnaFaticaCompletata("sonaglio");
    aggiornaTopbarProfilo();
    salvaProgressoCloud();
    renderContenutoFatiche();
    return;
...
async function rispondiAmazzone(nomeScelto) {
  ...
  if (amazzoneIndiceDomanda >= amazzoneDomande.length) {
    ...
    dracmeAttuali += dracmeVinte;
    segnaFaticaCompletata("amazzone");
...
async function tentaAfferraToro() {
  ...
  if (toroViteRimaste <= 0) {
    ...
    dracmeAttuali += premio;
    if (premio > 0) segnaFaticaCompletata("toro");
...
function tickGregge() {
  ...
  if (adesso >= greggeFineTs) {
    ...
    dracmeAttuali += premio;
    if (premio > 0) segnaFaticaCompletata("gregge");
    aggiornaTopbarProfilo();
    salvaProgressoCloud();
    renderContenutoFatiche();
    return;
...
async function gestisciClickAlberoGiardino(indice) {
  ...
  if (indice === giardinoSequenza[giardinoIndiceInput]) {
    ...
    dracmeAttuali += premio.dracme;
    if (premio.frammenti > 0) ambraAttuale += premio.frammenti;
    if (premio.dracme > 0) segnaFaticaCompletata("giardino");
